...
void Renderer::Init()
{
	...
	blendDesc.RenderTarget[0].SrcBlend = D3D11_BLEND_SRC_ALPHA; //背景＊α
	blendDesc.RenderTarget[0].DestBlend = D3D11_BLEND_INV_SRC_ALPHA;//背景＊　(1-α)
	...
	blendDesc.RenderTarget[0].DestBlend = D3D11_BLEND_ONE;//背景＊１
